...
def train():
  ...
  # Model
  conv_out1 = conv_layer(x_image, 5, 1, 32, args.batch_norm, "conv1")
  conv_out2 = conv_layer(conv_out1, 5, 32, 64, args.batch_norm, "conv2")
  ...
  for epoch in range(2001):
    ...
    if epoch % 100 == 0:
      [summary, train_accuracy] = sess.run([train_acc, accuracy], \
